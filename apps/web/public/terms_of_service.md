...
By creating an account, checking the box indicating that you agree to these Terms, accessing the Service, or using the Service, you confirm that you have read, understood, and agreed to these Terms and our Privacy Policy.

If you do not agree to these Terms, do not create an account or use the Service.

## 1. Apple and Other Application Stores
...
Certain features require a BillCompass account.

When creating and maintaining an account, you agree to:

* Provide accurate and current information;
* Use an email address that you are authorized to use;
* Keep your password, authentication tokens, devices, and account credentials secure;
* Not share your account with another person;
* Not impersonate another person or create a misleading identity;
* Promptly update information that becomes inaccurate; and
* Promptly contact us if you believe your account has been accessed without authorization.
...
* Divide bills evenly;
* Divide bills using custom amounts;
* Assign receipt items to participants;
* Record amounts that users believe are owed;
* View shared bills, balances, and activity;
* Mark an amount as paid;
* Confirm that an amount was paid; and
* Reverse or change a payment status.
...
* Verify whether a payment occurred;
* Guarantee that a user will pay an amount;
* Collect a debt on behalf of a user;
* Decide whether a debt is legally valid;
* Enforce payment obligations;
* Resolve financial disputes between users;
* Provide credit;
...
You are responsible for reviewing all information before creating, sharing, editing, confirming, settling, or relying on a bill.

This includes responsibility for checking:
...
* Deciding which users to add as friends;
* Deciding which groups to join;
* Confirming the identities of other participants;
* Deciding whether to accept or rely on a bill;
...
* Fees;
* Totals;
* Payment-method descriptions; and
* Partial card information printed on a receipt.
...
* You have the right to photograph, upload, and process the receipt;
* Your use of the receipt does not violate another person’s rights;
* You will not upload a receipt for an unlawful or fraudulent purpose; and
* You will not intentionally upload unnecessary sensitive information.
...
“User Content” means information or material that a user enters, uploads, creates, selects, shares, or transmits through the Service.
...
* Other information associated with bills, friendships, groups, or accounts.
...
* Process receipts and calculate bills;
* Maintain, secure, troubleshoot, and improve the Service;
* Prevent fraud, abuse, and security incidents;
* Enforce these Terms;
* Comply with legal obligations; and
* Exercise the rights described in our Privacy Policy.

This licence includes the right to permit service providers working on our behalf to process User Content for these purposes.

The licence continues for as long as reasonably necessary to provide the Service, maintain shared records, meet legal obligations, protect the Service, or complete deletion and backup processes described in our Privacy Policy.

### 9.3 Your responsibilities

You represent and warrant that:

* You own your User Content or have all permissions necessary to use and share it;
* Your User Content is accurate to the extent you represent it as factual;
* Your User Content does not violate applicable law;
* Your User Content does not infringe intellectual-property, privacy, contractual, confidentiality, or other rights;
* You have an appropriate reason to include each participant in a shared bill or group; and
* You will not use User Content to harass, deceive, threaten, embarrass, or harm another person.

You are responsible for information you enter about other people.

Do not enter another person’s sensitive, confidential, or private information unless you are authorized to do so and it is reasonably necessary for the expense-sharing purpose.

### 9.4 Visibility to other users

User Content associated with a shared bill, friendship, or group may be visible to the relevant users.

Depending on the feature, those users may see:

* Your display name;
* Your email address;
* Group membership;
* Shared bills;
* Bill descriptions and totals;
* Merchant and receipt information;
* Line items;
* Participant assignments;
* Amounts owed;
* Settlement statuses; and
* Related activity.

Do not submit User Content that you do not want the relevant participants to see.
...
3. Create a knowingly false, misleading, unauthorized, or fabricated bill;
4. Falsely state that another person owes money;
5. Falsely mark an amount as paid or confirmed;
6. Impersonate another person or misrepresent your identity;
7. Harass, threaten, stalk, intimidate, shame, exploit, or abuse another person;
8. Post content that is hateful, discriminatory, sexually explicit, obscene, threatening, or unlawfully violent;
9. Exploit, endanger, or solicit inappropriate interactions with a minor;
10. Violate another person’s privacy, confidentiality, publicity, contractual, or intellectual-property rights;
11. Upload malware, malicious code, corrupted files, or harmful content;
...
## 11. Reports, Moderation, and Removal

If you encounter content or behaviour that violates these Terms, contact:

**[privacy@split-the-bill.net](mailto:privacy@split-the-bill.net)**
...
* Correct, remove, or preserve content;
* Warn a user;
* Restrict account functionality;
* Suspend or terminate an account;
* Prevent further contact between users;
* Preserve evidence;
...
Removing another user as a friend does not necessarily delete shared bills, historical activity, group records, or information already visible to other participants.
...
* Your solo bills will be deleted;
* Your personal account information will be deleted or anonymized as described in the Privacy Policy;
* Your account will no longer be available for login;
* Shared bills involving other users may be retained;
* The amounts, participant shares, settlement statuses, and other shared-bill information may remain unchanged for the other participants; and
* Your display name associated with retained shared records will be replaced with “Deleted Account” or a similar anonymous label, and your email address will be replaced with an anonymous placeholder address.

You acknowledge that deleting your account does not entitle you to alter or delete another user’s copy of a shared bill or information that must reasonably remain available to other participants.
...
The technical method of suspension may include disabling login, revoking sessions, restricting functionality, removing information, blocking API access, or taking other reasonable measures.

You may terminate these Terms by stopping use of the Service and deleting your account.
...
* Continued support for an older application version;
* Permanent availability of any feature;
* Permanent storage of any data;
* Successful restoration from backups;
* A service-level agreement;
* Technical support within a specific period;
* Correction of every defect; or
* That the Service will always remain available.

We may add, remove, restrict, test, modify, replace, or discontinue any feature or the entire Service at any time.

We may perform maintenance without notice. We may also restrict the Service because of security issues, technical failures, third-party outages, legal requirements, resource limitations, or other operational reasons.

Where reasonably practical, we may provide notice of a material discontinuation, but we are not required to continue providing any free feature.
...
We will not charge you merely because you previously used the free Service. Before charging you, we will provide the required information and obtain your agreement or authorization as required by applicable law and applicable application-store rules.

A future paid feature may be governed by additional terms.
...
* RECEIPT EXTRACTION IS ACCURATE;
* INFORMATION ENTERED BY A USER IS TRUE;
* A PAYMENT OCCURRED;
* A USER WILL PAY AN AMOUNT;
* A DEBT IS VALID OR ENFORCEABLE;
* USER CONTENT WILL BE PRESERVED;
* LOST OR DELETED DATA CAN BE RECOVERED;
* THE SERVICE WILL BE UNINTERRUPTED OR ERROR-FREE;
* THE SERVICE WILL BE SECURE FROM EVERY THREAT;
* A DEFECT WILL BE CORRECTED;
* THE SERVICE WILL MEET YOUR REQUIREMENTS;
* THE SERVICE WILL WORK WITH EVERY DEVICE;
...
* DEVICE OR SOFTWARE DAMAGE;
* UNAUTHORIZED ACCESS;
* FINANCIAL LOSS;
* PERSONAL DISPUTE;
* RELATIONSHIP DAMAGE;
* FAILURE BY ANOTHER USER TO PAY;
* INCORRECT PAYMENT STATUS;
* INCORRECT BILL OR CALCULATION;
...
* A bill, debt, amount, or payment status you create or modify;
* A dispute between you and another user;
* Your fraudulent, misleading, negligent, or unauthorized conduct;
...
* Prevents a claim from being brought in an eligible small-claims court;
* Requires arbitration;
* Waives a right to participate in a class proceeding where that right cannot legally be waived; or
* Removes consumer rights or remedies that cannot legally be removed.

If you live outside Ontario, mandatory consumer-protection laws in your place of residence may give you additional rights. These Terms do not limit those rights where they must legally apply.
...
* New features;
* Changes to our business or technology;
* Platform requirements;
* Security practices;
* Legal or regulatory requirements; or
* Other operational needs.

The updated Terms will state their new effective date.

We may notify you of material changes through the Service, our website, your registered email address, or another reasonable method.

Where required by law, we will request that you affirmatively accept the updated Terms.

Otherwise, continuing to use the Service after updated Terms become effective constitutes acceptance of the updated Terms to the extent permitted by applicable law.

If you do not agree to an update, you must stop using the Service and may delete your account.
...
If any provision of these Terms is found invalid, illegal, or unenforceable, that provision will be enforced to the maximum extent permitted or severed, and the remaining provisions will remain in effect.
...
Except where expressly stated, these Terms do not give rights to a person who is not a party to them.
